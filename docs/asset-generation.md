...
- Web asset: `public/images/envelope.webp`
- Original PNG: `docs/source-assets/envelope.png`
- Alpha preserved; the frontend splits this photograph into flap and pocket layers using CSS clip-path and animates the letter with CSS 3D transforms.
...
Use case: photorealistic-natural. Asset type: editorial placeholder photograph for a romantic Thai Lanna wedding website. A quiet close-up still life of an ivory garden rose and white jasmine wedding bouquet with a flowing long deep burgundy silk ribbon resting on an antique dark teak wooden bench beside a traditional Northern Thai carved wooden window. Soft cream linen draped over the bench, a small bronze tray with two simple gold wedding rings. Warm afternoon window light, gentle shadows, fine analog film grain, muted natural colors, burgundy cream warm brown palette, sophisticated fine-art wedding photography. Vertical 1024x1536 composition, flowers in the lower center, carved window softly out of focus above, beautiful real material detail. No people, no letters, no text, no watermark. This is illustrative placeholder photography, not a photograph of a real wedding venue.
