...
export default function WeddingGallery() {
  ...
  return <main className="gallery-page">
    ...
    <header className="gallery-heading"><Botanical className="gallery-heading-botanical"/><span className="section-index">THE ART OF BEING TOGETHER</span><h1>ทุกภาพ…มีเรา</h1><p>บางช่วงเวลา ไม่ต้องการคำบรรยายมากไปกว่าความรัก</p><Flourish/><span className="gallery-placeholder-note">ภาพพรีเวดดิ้งสร้างสรรค์ด้วย AI จากภาพของเราสองคน</span></header>
