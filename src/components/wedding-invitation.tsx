...
function Countdown() {
  ...
  useEffect(() => {
    const update = () =>
      setRemaining(
        Math.max(0, new Date(wedding.dateISO).getTime() - Date.now()),
      );
  ...
  return (
    <div className="countdown" aria-label="เวลาที่เหลือก่อนวันงาน">
      {values.map((value, i) => (
...
export default function WeddingInvitation({ initialStage = "closed" }: { initialStage?: "closed" | "open" }) {
  ...
  function playMusic() {
    if (!audioRef.current || !wedding.music.src) return;
  ...
  return (
    <div className={`wedding-site stage-${stage}`}>
      ...
      {stage !== "open" && (
        <section className="envelope-screen" aria-label="จดหมายเชิญงานแต่งงาน">
          ...
          <header className="intro-top">
            ...
            <span className="eyebrow">A LETTER, WITH LOVE</span>
            <span className="intro-edition">LAMPANG · 2027</span>
          </header>
          <div className="intro-heading">
            ...
            <p className="intro-subtitle">
              ขอเรียนเชิญร่วมเป็นส่วนหนึ่งในวันสำคัญของเรา
            </p>
          </div>
          ...
          <button
            ...
            aria-label="เปิดซองจดหมายเชิญงานแต่งงาน"
            ...
            <span className="envelope-scene" aria-hidden="true">
              ...
              <span className="emerging-letter">
                <span className="letter-inner">
                  <span className="letter-kicker">เรากำลังจะแต่งงาน</span>
                  <span className="letter-names">
                    เบนซ์ <i>&</i> โปร
                  </span>
                  <Flourish />
                  <span className="letter-date">๓๐ · ๐๑ · ๒๕๗๐</span>
                  <span className="letter-venue">เฮือนคำหลวง · ลำปาง</span>
                </span>
              </span>
              <Image
          ...
          <div className="open-prompt">
            ...
            <p>
              {stage === "opening"
                ? "กำลังเปิดจดหมายแห่งความรัก…"
                : "แตะที่ซอง เพื่อเปิดคำเชิญ"}
            </p>
            <span className="prompt-line" />
          </div>
          <p className="sound-note">
            <Icon name={wedding.music.src ? "music" : "heart"} />{" "}
            {wedding.music.src
              ? "เปิดพร้อมเสียงเพลงเบา ๆ"
              : "ด้วยรัก จากใจของเราสองคน"}
          </p>
          <footer className="intro-bottom">
            <span>30 . 01 . 2027</span>
            <span className="tiny-diamond">✧</span>
            <span>เฮือนคำหลวง · ลำปาง</span>
          </footer>
          <button
      ...
      >
        ...
        <section className="hero-letter section-wrap" id="our-day">
          ...
          <div className="hero-copy">
            ...
            <h1 ref={titleRef} tabIndex={-1} className="couple-heading">
              เบนซ์ <span>&</span> โปร
            </h1>
            ...
            <p className="invitation-intro">
              ...
              <br />
              ขอเรียนเชิญท่านร่วมเป็นเกียรติ
              <br />
              และเป็นส่วนหนึ่งในงานมงคลสมรสของเรา
            </p>
            <div className="full-names">
              <p>
                {wedding.bride.name} <span>(เบนซ์)</span>
              </p>
              <span className="name-connector">และ</span>
              <p>
                {wedding.groom.name} <span>(โปร)</span>
              </p>
            </div>
            ...
            <p className="hero-place">
              เวลา 08.30 น. · ณ {wedding.venue} จังหวัดลำปาง
            </p>
            <a className="text-link" href="#schedule">
              รายละเอียดวันแห่งความสุข <Icon name="down" />
            </a>
          </div>
          <figure className="hero-photo">
            <div className="photo-arch">
              <WeddingMedia onVideoPlay={() => audioRef.current?.pause()} />
            </div>
        ...
        <section className="family-section section-wrap reveal">
          ...
          <div className="families">
            <div>
              <span className="family-label">ครอบครัวเจ้าสาว</span>
              {wedding.bride.parents.map((name) => (
                <p key={name}>{name}</p>
              ))}
            </div>
            <span className="families-and">&</span>
            <div>
              <span className="family-label">ครอบครัวเจ้าบ่าว</span>
              {wedding.groom.parents.map((name) => (
                <p key={name}>{name}</p>
              ))}
            </div>
          </div>
          <p className="family-invite">
            ...
            <br className="mobile-break" /> เนื่องในพิธีมงคลสมรสของบุตรทั้งสอง
          </p>
        </section>

        <section className="countdown-section">
          <Botanical className="countdown-botanical" />
          <div className="section-wrap countdown-inner reveal">
            <div>
              <p className="eyebrow">COUNTING THE MOMENTS</p>
              <h2 className="script-heading">นับวัน…ให้ถึงวันของเรา</h2>
              <p>อีกไม่นาน เราจะได้พบกัน</p>
            </div>
            <Countdown />
          </div>
        </section>
        ...
        <section className="schedule-section section-wrap reveal" id="schedule">
          <div className="section-heading">
            <span className="section-index">01 / THE CELEBRATION</span>
            <h2 className="script-heading">ลำดับความสุข</h2>
        ...
        <section className="dress-section reveal" id="dress-code">
          <div className="dress-inner section-wrap">
            <div className="dress-copy">
              <span className="section-index">02 / DRESS WITH LOVE</span>
              <h2 className="script-heading">แต่งแต้มวันแห่งรัก</h2>
              <p>
                ร่วมเติมสีสันให้วันของเรา
                <br />
                ด้วยชุดโทนสีแดง ครีม หรือน้ำตาล
                <br />
                <span className="dress-note">
                  กลิ่นอายล้านนา ในแบบที่เป็นคุณ
                </span>
              </p>
            </div>
            <div className="color-palette">
              <div className="color-swatch">
                <span style={{ background: "#761f32" }} />
                <p>แดงเบอร์กานดี้</p>
                <small>BURGUNDY</small>
              </div>
              <div className="color-swatch">
                <span style={{ background: "#eedfc5" }} />
                <p>ครีม</p>
                <small>CREAM</small>
              </div>
              <div className="color-swatch">
                <span style={{ background: "#88502f" }} />
                <p>น้ำตาล</p>
                <small>WARM BROWN</small>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="location-section section-wrap reveal" id="location">
          <div className="venue-art" aria-hidden="true">
            <Botanical className="venue-botanical" />
            <svg
              viewBox="0 0 400 260"
              fill="none"
              stroke="currentColor"
              strokeWidth="1.2"
            >
              <path d="M30 238h340M54 225h292M80 220V130m240 90V130M60 143 200 57l140 86H60Zm21-12 119-71 119 71M180 67V46l20-27 20 27v21M183 46h34M200 19v32M103 125h194M106 132v88m188-88v88M124 220v-76h56v76m40 0v-76h56v76M137 145v66m30-66v66m66-66v66m30-66v66M103 182h194M80 207h240M82 196h236M187 144h26v76M170 89h60M151 101h99M129 113h142M50 143c-9-8-13-22-12-29 10 10 18 10 26 14m272 0c8-4 16-4 26-14 1 7-3 21-12 29" />
              <path d="M30 238c-9-29-14-60 3-72 13 18 11 37-3 72Zm340 0c9-29 14-60-3-72-13 18-11 37 3 72Z" />
            </svg>
            <span>เฮือนแห่งความฮัก</span>
            <span className="venue-art-sub">LAMPANG, THAILAND</span>
          </div>
          <div className="location-copy">
            <span className="section-index">03 / MEET US HERE</span>
            <h2 className="script-heading">พบกันที่…</h2>
            <h3>{wedding.venue}</h3>
            <p>{wedding.address}</p>
            ...
            >
              <Icon name="map" /> เปิดแผนที่ Google Maps <Icon name="arrow" />
            </a>
            <p className="plus-code">ตำแหน่งสถานที่ · {wedding.plusCode}</p>
          </div>
        </section>
        ...
        <footer className="wedding-footer">
          ...
          <p>ขอบคุณที่เป็นส่วนหนึ่งในเรื่องราวของเรา</p>
          <h2>แล้วพบกันในวันแห่งความรัก</h2>
          <span className="footer-names">
            เบนซ์ <i>&</i> โปร
          </span>
          <span className="footer-date">๓๐ · ๐๑ · ๒๕๗๐</span>
          <Flourish />
          <p className="footer-apology">ขออภัยหากมิได้มาเรียนเชิญด้วยตนเอง</p>
          <button className="back-envelope" onClick={closeLetter}>
            <Icon name="envelope" /> กลับไปที่ซองจดหมาย
          </button>
          {wedding.music.src && (
            <a
              ...
              rel="noopener noreferrer"
            >
              เพลง {wedding.music.title} · {wedding.music.artist} / Pixabay
            </a>
          )}
        </footer>
      </main>

      {stage === "open" && wedding.music.src && (
        <div className="music-control">
          <button
            ...
            aria-label={playing ? "ปิดเพลงประกอบ" : "เปิดเพลงประกอบ"}
            aria-pressed={playing}
          >
            <Icon name={playing ? "music" : "mute"} />
            <span>{playing ? "เพลงกำลังบรรเลง" : "เปิดเสียงเพลง"}</span>
            {playing && (
          ...
          {audioError && (
            <span className="audio-message" role="status">
              ยังเล่นเพลงไม่ได้ ลองเปิดอีกครั้ง
            </span>
          )}
        </div>
      )}
      <noscript>
        <div className="noscript-invitation">
          <h1>งานมงคลสมรส เบนซ์ & โปร</h1>
          <p>
            {wedding.bride.name} และ {wedding.groom.name}
          </p>
          <p>{wedding.dateLabel} เวลา 08.30 น.</p>
          <p>
            {wedding.venue} {wedding.address}
          </p>
          <a href={wedding.mapsUrl}>เปิดแผนที่ Google Maps</a>
          <p>เปิด JavaScript เพื่อชมแอนิเมชันและรายละเอียดทั้งหมด</p>
        </div>
      </noscript>
    </div>
  );
